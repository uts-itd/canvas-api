...
function default_1(helper) {
    return {
         ...
         * @returns {Promise<any>}
         */
        listUsersInAccount: (accountId, query) => helper.get(`/v1/accounts/${accountId}/users`, query),
        /**
         ...
         * @returns {Promise<any>}
         */
        listTodoItems: (query) => helper.get(`/v1/users/self/todo`, query),
        /**
         ...
         * @returns {Promise<any>}
         */
        listCountsForTodoItems: (query) => helper.get(`/v1/users/self/todo_item_count`, query),
        /**
         ...
         * @returns {Promise<any>}
         */
        listMissingSubmissions: (userId, query) => helper.get(`/v1/users/${userId}/missing_submissions`, query),
        /**
         ...
         * @returns {Promise<any>}
         */
        hideStreamItem: (activityStreaId) => helper.delete(`/v1/users/self/activity_stream/${activityStreaId}`),
        /**
         ...
         * @returns {Promise<any>}
         */
        uploadFile: (userId) => helper.post(`/v1/users/${userId}/files`),
        /**
         ...
         * @returns {Promise<any>}
         */
        showUserDetails: (userId) => helper.get(`/v1/users/${userId}`),
        /**
         ...
         * @returns {Promise<any>}
         */
        createUser: (accountId, body) => helper.post(`/v1/accounts/${accountId}/users`, body),
        /**
         ...
         * @returns {Promise<any>}
         */
        selfRegisterUser: (accountId, body) => helper.post(`/v1/accounts/${accountId}/self_registration`, body),
        /**
         ...
         * @returns {Promise<any>}
         */
        updateUserSettings: (userId, query) => helper.get(`/v1/users/${userId}/settings`, query),
        /**
         ...
         * @returns {Promise<any>}
         */
        getCustomColors: (userId) => helper.get(`/v1/users/${userId}/colors`),
        /**
         ...
         * @returns {Promise<any>}
         */
        getCustomColor: (userId, assetString) => helper.get(`/v1/users/${userId}/colors/${assetString}`),
        /**
         ...
         * @returns {Promise<any>}
         */
        updateCustomColor: (userId, assetString, body) => helper.put(`/v1/users/${userId}/colors/${assetString}`, body),
        /**
         ...
         * @returns {Promise<any>}
         */
        getDashboardPositions: (userId) => helper.get(`/v1/users/${userId}/dashboard_positions`),
        /**
         ...
         * @returns {Promise<any>}
         */
        updateDashboardPositions: (userId) => helper.put(`/v1/users/${userId}/dashboard_positions`),
        /**
         ...
         * @returns {Promise<any>}
         */
        editUser: (userId, body) => helper.put(`/v1/users/${userId}`, body),
        /**
         ...
         * @returns {Promise<any>}
         */
        mergeUserIntoAnotherUserDestinationUserId: (userId, destinationUserId) => helper.put(`/v1/users/${userId}/merge_into/${destinationUserId}`),
        /**
         * Merge a user into another user. To merge users, the caller must have permissions to manage both users. This should be considered irreversible. This will delete the user and move all the data into the destination user. When finding users by SIS ids in different accounts the destination_account_id is required. The account can also be identified by passing the domain in destination_account_id.
         * @summary Merge user into another user
         * @param {string|number} userId Canvas User ID
         ...
         * @returns {Promise<any>}
         */
        mergeUserIntoAnotherUserAccounts: (userId, destinationAccountId, destinationUserId) => helper.put(`/v1/users/${userId}/merge_into/accounts/${destinationAccountId}/users/${destinationUserId}`),
        /**
         ...
         * @returns {Promise<any>}
         */
        splitMergedUsersIntoSeparateUsers: (userId) => helper.post(`/v1/users/${userId}/split`),
        /**
         ...
         * @returns {Promise<any>}
         */
        getPandataEventsJwtTokenAndItsExpirationDate: (body) => helper.post(`/v1/users/self/pandata_events_token`, body),
        /**
         ...
         * @returns {Promise<any>}
         */
        getUserProfile: (userId) => helper.get(`/v1/users/${userId}/profile`),
        /**
         ...
         * @returns {Promise<any>}
         */
        listAvatarOptions: (userId) => helper.get(`/v1/users/${userId}/avatars`),
        /**
         ...
         * @returns {Promise<any>}
         */
        listUserPageViews: (userId, query) => helper.get(`/v1/users/${userId}/page_views`, query),
        /**
         ...
         * @returns {Promise<any>}
         */
        storeCustomData: (userId, body, scope = '') => helper.put(`/v1/users/${userId}/custom_data/${scope}`, body),
        /**
         ...
         * @returns {Promise<any>}
         */
        loadCustomData: (userId, query, scope = '') => helper.get(`/v1/users/${userId}/custom_data/${scope}`, query),
        /**
         ...
         * @returns {Promise<any>}
         */
        deleteCustomData: (userId, query, scope = '') => helper.delete(`/v1/users/${userId}/custom_data/${scope}`, query),
        /**
         ...
         * @returns {Promise<any>}
         */
        getCourseNickname: (courseId) => helper.get(`/v1/users/self/course_nicknames/${courseId}`),
        /**
         ...
         * @returns {Promise<any>}
         */
        setCourseNickname: (courseId, body) => helper.put(`/v1/users/self/course_nicknames/${courseId}`, body),
        /**
         ...
         * @returns {Promise<any>}
         */
        removeCourseNickname: (courseId) => helper.delete(`/v1/users/self/course_nicknames/${courseId}`),
        /**

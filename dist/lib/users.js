...
var users = {
     ...
     * @returns {Promise<any>}
     */
    listUsersInAccount: function (accountId, query) {
        if (query === void 0) { query = ''; }
        return helper.get("/v1/accounts/" + accountId + "/users", query);
    },
    /**
     ...
     * @returns {Promise<any>}
     */
    listActivityStreamSelf: function () { return helper.get("/v1/users/self/activity_stream"); },
    /**
     * Returns the current user's global activity stream, paginated. There are many types of objects that can be returned in the activity stream. All object types have the same basic set of shared attributes:  !!!javascript  {   'created_at': '2011-07-13T09:12:00Z',   'updated_at': '2011-07-25T08:52:41Z',   'id': 1234,   'title': 'Stream Item Subject',   'message': 'This is the body text of the activity stream item. It is plain-text, and can be multiple paragraphs.',   'type': 'DiscussionTopic|Conversation|Message|Submission|Conference|Collaboration|AssessmentRequest...',   'read_state': false,   'context_type': 'course', // course|group   'course_id': 1,   'group_id': null,   'html_url': "http://..." // URL to the Canvas web UI for this stream item  } In addition, each item type has its own set of attributes available. DiscussionTopic:  !!!javascript  {   'type': 'DiscussionTopic',   'discussion_topic_id': 1234,   'total_root_discussion_entries': 5,   'require_initial_post': true,   'user_has_posted': true,   'root_discussion_entries': {    ...   }  } For DiscussionTopic, the message is truncated at 4kb. Announcement:  !!!javascript  {   'type': 'Announcement',   'announcement_id': 1234,   'total_root_discussion_entries': 5,   'require_initial_post': true,   'user_has_posted': null,   'root_discussion_entries': {    ...   }  } For Announcement, the message is truncated at 4kb. Conversation:  !!!javascript  {   'type': 'Conversation',   'conversation_id': 1234,   'private': false,   'participant_count': 3,  } Message:  !!!javascript  {   'type': 'Message',   'message_id': 1234,   'notification_category': 'Assignment Graded'  } Submission: Returns an {api:Submissions:Submission Submission} with its Course and Assignment data. Conference:  !!!javascript  {   'type': 'Conference',   'web_conference_id': 1234  } Collaboration:  !!!javascript  {   'type': 'Collaboration',   'collaboration_id': 1234  } AssessmentRequest:  !!!javascript  {   'type': 'AssessmentRequest',   'assessment_request_id': 1234  }
     * @summary List the activity stream
     * @returns {Promise<any>}
     */
    listActivityStreamActivityStream: function () { return helper.get("/v1/users/activity_stream"); },
    /**
     * Returns a summary of the current user's global activity stream.
     * @summary Activity stream summary
     * @returns {Promise<any>}
     */
    activityStreamSummary: function () { return helper.get("/v1/users/self/activity_stream/summary"); },
    /**
     ...
     * @returns {Promise<any>}
     */
    listTodoItems: function (query) {
        if (query === void 0) { query = ''; }
        return helper.get("/v1/users/self/todo", query);
    },
    /**
     ...
     * @returns {Promise<any>}
     */
    listCountsForTodoItems: function (query) {
        if (query === void 0) { query = ''; }
        return helper.get("/v1/users/self/todo_item_count", query);
    },
    /**
     ...
     * @returns {Promise<any>}
     */
    listUpcomingAssignmentsCalendarEvents: function () { return helper.get("/v1/users/self/upcoming_events"); },
    /**
     ...
     * @returns {Promise<any>}
     */
    listMissingSubmissions: function (userId, query) {
        if (query === void 0) { query = ''; }
        return helper.get("/v1/users/" + userId + "/missing_submissions", query);
    },
    /**
     ...
     * @returns {Promise<any>}
     */
    hideStreamItem: function (activityStreaId) { return helper.delete("/v1/users/self/activity_stream/" + activityStreaId); },
    /**
     * Hide all stream items for the user
     * @summary Hide all stream items
     * @returns {Promise<any>}
     */
    hideAllStreamItems: function () { return helper.delete("/v1/users/self/activity_stream"); },
    /**
     ...
     * @returns {Promise<any>}
     */
    uploadFile: function (userId) { return helper.post("/v1/users/" + userId + "/files"); },
    /**
     ...
     * @returns {Promise<any>}
     */
    showUserDetails: function (userId) { return helper.get("/v1/users/" + userId); },
    /**
     ...
     * @returns {Promise<any>}
     */
    createUser: function (accountId, body) { return helper.post("/v1/accounts/" + accountId + "/users", body); },
    /**
     ...
     * @returns {Promise<any>}
     */
    selfRegisterUser: function (accountId, body) { return helper.post("/v1/accounts/" + accountId + "/self_registration", body); },
    /**
     ...
     * @returns {Promise<any>}
     */
    updateUserSettings: function (userId, query) {
        if (query === void 0) { query = ''; }
        return helper.get("/v1/users/" + userId + "/settings", query);
    },
    /**
     ...
     * @returns {Promise<any>}
     */
    getCustomColors: function (userId) { return helper.get("/v1/users/" + userId + "/colors"); },
    /**
     ...
     * @returns {Promise<any>}
     */
    getCustomColor: function (userId, assetString) { return helper.get("/v1/users/" + userId + "/colors/" + assetString); },
    /**
     ...
     * @returns {Promise<any>}
     */
    updateCustomColor: function (userId, assetString, body) { return helper.put("/v1/users/" + userId + "/colors/" + assetString, body); },
    /**
     ...
     * @returns {Promise<any>}
     */
    getDashboardPositions: function (userId) { return helper.get("/v1/users/" + userId + "/dashboard_positions"); },
    /**
     ...
     * @returns {Promise<any>}
     */
    updateDashboardPositions: function (userId) { return helper.put("/v1/users/" + userId + "/dashboard_positions"); },
    /**
     ...
     * @returns {Promise<any>}
     */
    editUser: function (userId, body) { return helper.put("/v1/users/" + userId, body); },
    /**
     ...
     * @returns {Promise<any>}
     */
    mergeUserIntoAnotherUserDestinationUserId: function (userId, destinationUserId) { return helper.put("/v1/users/" + userId + "/merge_into/" + destinationUserId); },
    /**
     * Merge a user into another user. To merge users, the caller must have permissions to manage both users. This should be considered irreversible. This will delete the user and move all the data into the destination user. When finding users by SIS ids in different accounts the destination_account_id is required. The account can also be identified by passing the domain in destination_account_id.
     * @summary Merge user into another user
     * @param {string} userId Canvas User ID
     ...
     * @returns {Promise<any>}
     */
    mergeUserIntoAnotherUserAccounts: function (userId, destinationAccountId, destinationUserId) { return helper.put("/v1/users/" + userId + "/merge_into/accounts/" + destinationAccountId + "/users/" + destinationUserId); },
    /**
     ...
     * @returns {Promise<any>}
     */
    splitMergedUsersIntoSeparateUsers: function (userId) { return helper.post("/v1/users/" + userId + "/split"); },
    /**
     ...
     * @returns {Promise<any>}
     */
    getPandataEventsJwtTokenAndItsExpirationDate: function (body) { return helper.post("/v1/users/self/pandata_events_token", body); },
    /**
     ...
     * @returns {Promise<any>}
     */
    getUserProfile: function (userId) { return helper.get("/v1/users/" + userId + "/profile"); },
    /**
     ...
     * @returns {Promise<any>}
     */
    listAvatarOptions: function (userId) { return helper.get("/v1/users/" + userId + "/avatars"); },
    /**
     ...
     * @returns {Promise<any>}
     */
    listUserPageViews: function (userId, query) {
        if (query === void 0) { query = ''; }
        return helper.get("/v1/users/" + userId + "/page_views", query);
    },
    /**
     ...
     * @returns {Promise<any>}
     */
    storeCustomData: function (userId, body, scope) {
        if (scope === void 0) { scope = ''; }
        return helper.put("/v1/users/" + userId + "/custom_data/" + scope, body);
    },
    /**
     ...
     * @returns {Promise<any>}
     */
    loadCustomData: function (userId, query, scope) {
        if (scope === void 0) { scope = ''; }
        return helper.get("/v1/users/" + userId + "/custom_data/" + scope, query);
    },
    /**
     ...
     * @returns {Promise<any>}
     */
    deleteCustomData: function (userId, query, scope) {
        if (scope === void 0) { scope = ''; }
        return helper.delete("/v1/users/" + userId + "/custom_data/" + scope, query);
    },
    /**
     ...
     * @returns {Promise<any>}
     */
    listCourseNicknames: function () { return helper.get("/v1/users/self/course_nicknames"); },
    /**
     ...
     * @returns {Promise<any>}
     */
    getCourseNickname: function (courseId) { return helper.get("/v1/users/self/course_nicknames/" + courseId); },
    /**
     ...
     * @returns {Promise<any>}
     */
    setCourseNickname: function (courseId, body) { return helper.put("/v1/users/self/course_nicknames/" + courseId, body); },
    /**
     ...
     * @returns {Promise<any>}
     */
    removeCourseNickname: function (courseId) { return helper.delete("/v1/users/self/course_nicknames/" + courseId); },
    /**

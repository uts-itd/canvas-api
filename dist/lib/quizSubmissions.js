...
var quizSubmissions = {
     ...
     * @returns {Promise<any>}
     */
    getAllQuizSubmissions: function (courseId, quizId, query) {
        if (query === void 0) { query = ''; }
        return helper.get("/v1/courses/" + courseId + "/quizzes/" + quizId + "/submissions", query);
    },
    /**
     ...
     * @returns {Promise<any>}
     */
    getQuizSubmission: function (courseId, quizId, query) {
        if (query === void 0) { query = ''; }
        return helper.get("/v1/courses/" + courseId + "/quizzes/" + quizId + "/submission", query);
    },
    /**
     ...
     * @returns {Promise<any>}
     */
    getSingleQuizSubmission: function (courseId, quizId, submissionId, query) {
        if (query === void 0) { query = ''; }
        return helper.get("/v1/courses/" + courseId + "/quizzes/" + quizId + "/submissions/" + submissionId, query);
    },
    /**
     ...
     * @returns {Promise<any>}
     */
    createQuizSubmissionStartQuizTakingSession: function (courseId, quizId, body) { return helper.post("/v1/courses/" + courseId + "/quizzes/" + quizId + "/submissions", body); },
    /**
     ...
     * @returns {Promise<any>}
     */
    updateStudentQuestionScoresAndComments: function (courseId, quizId, submissionId, body) { return helper.put("/v1/courses/" + courseId + "/quizzes/" + quizId + "/submissions/" + submissionId, body); },
    /**
     ...
     * @returns {Promise<any>}
     */
    completeQuizSubmissionTurnItIn: function (courseId, quizId, submissionId, body) { return helper.post("/v1/courses/" + courseId + "/quizzes/" + quizId + "/submissions/" + submissionId + "/complete", body); },
    /**

...
var ePubExports = {
     ...
     * @returns {Promise<any>}
     */
    listCoursesWithTheirLatestEpubExport: function () { return helper.get("/v1/epub_exports"); },
    /**
     ...
     * @returns {Promise<any>}
     */
    createEpubExport: function (courseId) { return helper.post("/v1/courses/" + courseId + "/epub_exports"); },
    /**

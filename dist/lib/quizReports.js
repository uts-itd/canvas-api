...
var quizReports = {
     ...
     * @returns {Promise<any>}
     */
    retrieveAllQuizReports: function (courseId, quizId, query) {
        if (query === void 0) { query = ''; }
        return helper.get("/v1/courses/" + courseId + "/quizzes/" + quizId + "/reports", query);
    },
    /**
     ...
     * @returns {Promise<any>}
     */
    createQuizReport: function (courseId, quizId, body) { return helper.post("/v1/courses/" + courseId + "/quizzes/" + quizId + "/reports", body); },
    /**
     ...
     * @returns {Promise<any>}
     */
    getQuizReport: function (courseId, quizId, reportId, query) {
        if (query === void 0) { query = ''; }
        return helper.get("/v1/courses/" + courseId + "/quizzes/" + quizId + "/reports/" + reportId, query);
    },
    /**

...
var accounts = {
     ...
     * @returns {Promise<any>}
     */
    listAccounts: function (query) {
        if (query === void 0) { query = ''; }
        return helper.get("/v1/accounts", query);
    },
    /**
     ...
     * @returns {Promise<any>}
     */
    listAccountsForCourseAdmins: function () { return helper.get("/v1/course_accounts"); },
    /**
     ...
     * @returns {Promise<any>}
     */
    getSingleAccount: function (accountId) { return helper.get("/v1/accounts/" + accountId); },
    /**
     ...
     * @returns {Promise<any>}
     */
    permissions: function (accountId, query) {
        if (query === void 0) { query = ''; }
        return helper.get("/v1/accounts/" + accountId + "/permissions", query);
    },
    /**
     ...
     * @returns {Promise<any>}
     */
    getSubAccountsOfAccount: function (accountId, query) {
        if (query === void 0) { query = ''; }
        return helper.get("/v1/accounts/" + accountId + "/sub_accounts", query);
    },
    /**
     *
     ...
     * @returns {Promise<any>}
     */
    returnsTermsOfServiceForThatAccount: function (accountId) { return helper.get("/v1/accounts/" + accountId + "/terms_of_service"); },
    /**
     ...
     * @returns {Promise<any>}
     */
    listActiveCoursesInAccount: function (accountId, query) {
        if (query === void 0) { query = ''; }
        return helper.get("/v1/accounts/" + accountId + "/courses", query);
    },
    /**
     ...
     * @returns {Promise<any>}
     */
    updateAccount: function (accountId, body) { return helper.put("/v1/accounts/" + accountId, body); },
    /**
     ...
     * @returns {Promise<any>}
     */
    deleteUserFromRootAccount: function (accountId, userId) { return helper.delete("/v1/accounts/" + accountId + "/users/" + userId); },
    /**
     ...
     * @returns {Promise<any>}
     */
    createNewSubAccount: function (accountId, body) { return helper.post("/v1/accounts/" + accountId + "/sub_accounts", body); },
    /**

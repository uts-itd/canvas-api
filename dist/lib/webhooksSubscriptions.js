...
var webhooksSubscriptions = {
     ...
     * @returns {Promise<any>}
     */
    createWebhookSubscription: function (body) { return helper.post("/lti/subscriptions", body); },
    /**
     *
     ...
     * @returns {Promise<any>}
     */
    deleteWebhookSubscription: function (subscriptionId) { return helper.delete("/lti/subscriptions/" + subscriptionId); },
    /**
     *
     ...
     * @returns {Promise<any>}
     */
    showSingleWebhookSubscription: function (subscriptionId) { return helper.get("/lti/subscriptions/" + subscriptionId); },
    /**
     ...
     * @returns {Promise<any>}
     */
    updateWebhookSubscription: function (subscriptionId) { return helper.put("/lti/subscriptions/" + subscriptionId); },
    /**

...
let courses = {
     ...
     * @returns {Promise<any>}
     */
    listYourCourses: (query = '') => helper.get(`/v1/courses`, query),
    /**
     ...
     * @returns {Promise<any>}
     */
    listCoursesForUser: (userId, query = '') => helper.get(`/v1/users/${userId}/courses`, query),
    /**
     * Create a new course
     ...
     * @returns {Promise<any>}
     */
    createNewCourse: (accountId, body) => helper.post(`/v1/accounts/${accountId}/courses`, body),
    /**
     ...
     * @returns {Promise<any>}
     */
    uploadFile: (courseId) => helper.post(`/v1/courses/${courseId}/files`),
    /**
     ...
     * @returns {Promise<any>}
     */
    listStudents: (courseId) => helper.get(`/v1/courses/${courseId}/students`),
    /**
     ...
     * @returns {Promise<any>}
     */
    listUsersInCourseUsers: (courseId, query = '') => helper.get(`/v1/courses/${courseId}/users`, query),
    /**
     * Returns the paginated list of users in this course. And optionally the user's enrollments in the course.
     * @summary List users in course
     * @param {string} courseId Canvas Course ID
     ...
     * @returns {Promise<any>}
     */
    listUsersInCourseSearchUsers: (courseId, query = '') => helper.get(`/v1/courses/${courseId}/search_users`, query),
    /**
     ...
     * @returns {Promise<any>}
     */
    listRecentlyLoggedInStudents: (courseId) => helper.get(`/v1/courses/${courseId}/recent_students`),
    /**
     ...
     * @returns {Promise<any>}
     */
    getSingleUser: (courseId, userId) => helper.get(`/v1/courses/${courseId}/users/${userId}`),
    /**
     ...
     * @returns {Promise<any>}
     */
    previewProcessedHtml: (courseId, body) => helper.post(`/v1/courses/${courseId}/preview_html`, body),
    /**
     ...
     * @returns {Promise<any>}
     */
    courseActivityStream: (courseId) => helper.get(`/v1/courses/${courseId}/activity_stream`),
    /**
     ...
     * @returns {Promise<any>}
     */
    courseActivityStreamSummary: (courseId) => helper.get(`/v1/courses/${courseId}/activity_stream/summary`),
    /**
     ...
     * @returns {Promise<any>}
     */
    courseTodoItems: (courseId) => helper.get(`/v1/courses/${courseId}/todo`),
    /**
     ...
     * @returns {Promise<any>}
     */
    deleteConcludeCourse: (courseId, query) => helper.delete(`/v1/courses/${courseId}`, query),
    /**
     ...
     * @returns {Promise<any>}
     */
    getCourseSettings: (courseId) => helper.get(`/v1/courses/${courseId}/settings`),
    /**
     ...
     * @returns {Promise<any>}
     */
    updateCourseSettings: (courseId, body) => helper.put(`/v1/courses/${courseId}/settings`, body),
    /**
     ...
     * @returns {Promise<any>}
     */
    getSingleCourseCourses: (courseId, query = '') => helper.get(`/v1/courses/${courseId}`, query),
    /**
     * Return information on a single course. Accepts the same include[] parameters as the list action.
     * @summary Get a single course
     * @param {string} accountId Canvas Account ID
     ...
     * @returns {Promise<any>}
     */
    getSingleCourseAccounts: (accountId, courseId, query = '') => helper.get(`/v1/accounts/${accountId}/courses/${courseId}`, query),
    /**
     ...
     * @returns {Promise<any>}
     */
    updateCourse: (courseId, body) => helper.put(`/v1/courses/${courseId}`, body),
    /**
     ...
     * @returns {Promise<any>}
     */
    updateCourses: (accountId, body) => helper.put(`/v1/accounts/${accountId}/courses`, body),
    /**
     ...
     * @returns {Promise<any>}
     */
    resetCourse: (courseId) => helper.post(`/v1/courses/${courseId}/reset_content`),
    /**
     ...
     * @returns {Promise<any>}
     */
    getEffectiveDueDates: (courseId, query = '') => helper.get(`/v1/courses/${courseId}/effective_due_dates`, query),
    /**
     ...
     * @returns {Promise<any>}
     */
    permissions: (courseId, query = '') => helper.get(`/v1/courses/${courseId}/permissions`, query),
    /**
     ...
     * @returns {Promise<any>}
     */
    getCourseCopyStatus: (courseId, courseCopId) => helper.get(`/v1/courses/${courseId}/course_copy/${courseCopId}`),
    /**
     ...
     * @returns {Promise<any>}
     */
    copyCourseContent: (courseId, body) => helper.post(`/v1/courses/${courseId}/course_copy`, body),
};

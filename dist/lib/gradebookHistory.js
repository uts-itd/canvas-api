...
var gradebookHistory = {
     ...
     * @returns {Promise<any>}
     */
    daysInGradebookHistoryForThisCourse: function (courseId) { return helper.get("/v1/courses/" + courseId + "/gradebook_history/days"); },
    /**
     ...
     * @returns {Promise<any>}
     */
    detailsForGivenDateInGradebookHistoryForThisCourse: function (courseId, date) { return helper.get("/v1/courses/" + courseId + "/gradebook_history/" + date); },
    /**
     ...
     * @returns {Promise<any>}
     */
    listsSubmissions: function (courseId, date, graderId, assignmentId) { return helper.get("/v1/courses/" + courseId + "/gradebook_history/" + date + "/graders/" + graderId + "/assignments/" + assignmentId + "/submissions"); },
    /**
     ...
     * @returns {Promise<any>}
     */
    listUncollatedSubmissionVersions: function (courseId, query) {
        if (query === void 0) { query = ''; }
        return helper.get("/v1/courses/" + courseId + "/gradebook_history/feed", query);
    },
};

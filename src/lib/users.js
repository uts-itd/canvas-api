module.exports = (helper) => {
  return {
     ...
     * @returns {Promise<any>}
     */
    listUsersInAccount: (accountId, query = '') =>
     ...
     * @returns {Promise<any>}
     */
    listActivityStreamActivityStream: () =>
      helper.get(`/v1/users/activity_stream`),
    /**
    ...
    activityStreamSummary: () =>
      helper.get(`/v1/users/self/activity_stream/summary`),
    /**
     ...
     * @returns {Promise<any>}
     */
    listCountsForTodoItems: (query = '') =>
      helper.get(`/v1/users/self/todo_item_count`, query),
    /**
     ...
     * @returns {Promise<any>}
     */
    listUpcomingAssignmentsCalendarEvents: () =>
      helper.get(`/v1/users/self/upcoming_events`),
    /**
     ...
     * @returns {Promise<any>}
     */
    listMissingSubmissions: (userId, query = '') =>
     ...
     * @returns {Promise<any>}
     */
    hideStreamItem: (activityStreaId) =>
     ...
     * @returns {Promise<any>}
     */
    selfRegisterUser: (accountId, body) =>
     ...
     * @returns {Promise<any>}
     */
    updateUserSettings: (userId, query = '') =>
     ...
     * @returns {Promise<any>}
     */
    getCustomColor: (userId, assetString) =>
     ...
     * @returns {Promise<any>}
     */
    updateCustomColor: (userId, assetString, body) =>
     ...
     * @returns {Promise<any>}
     */
    updateDashboardPositions: (userId) =>
     ...
     * @returns {Promise<any>}
     */
    mergeUserIntoAnotherUserDestinationUserId: (userId, destinationUserId) =>
     ...
     * @returns {Promise<any>}
     */
    splitMergedUsersIntoSeparateUsers: (userId) =>
     ...
     * @returns {Promise<any>}
     */
    getPandataEventsJwtTokenAndItsExpirationDate: (body) =>
     ...
     * @returns {Promise<any>}
     */
    listUserPageViews: (userId, query = '') =>
     ...
     * @returns {Promise<any>}
     */
    storeCustomData: (userId, body, scope = '') =>
     ...
     * @returns {Promise<any>}
     */
    loadCustomData: (userId, query, scope = '') =>
     ...
     * @returns {Promise<any>}
     */
    deleteCustomData: (userId, query, scope = '') =>
     ...
     * @returns {Promise<any>}
     */
    setCourseNickname: (courseId, body) =>
    ...
    clearCourseNicknames: () =>
      helper.delete(`/v1/users/self/course_nicknames`),
  };
};

module.exports = (helper) => {
  return {
     ...
     * @returns {Promise<any>}
     */
    updateCreateFrontPageCourses: (courseId, body) =>
     ...
     * @returns {Promise<any>}
     */
    updateCreateFrontPageGroups: (groupId, body) =>
     ...
     * @returns {Promise<any>}
     */
    listPagesCourses: (courseId, query = '') =>
     ...
     * @returns {Promise<any>}
     */
    createPageCourses: (courseId, body) =>
     ...
     * @returns {Promise<any>}
     */
    updateCreatePageCourses: (courseId, url, body) =>
     ...
     * @returns {Promise<any>}
     */
    updateCreatePageGroups: (groupId, url, body) =>
     ...
     * @returns {Promise<any>}
     */
    deletePageCourses: (courseId, url) =>
     ...
     * @returns {Promise<any>}
     */
    listRevisionsCourses: (courseId, url) =>
     ...
     * @returns {Promise<any>}
     */
    listRevisionsGroups: (groupId, url) =>
     ...
     * @returns {Promise<any>}
     */
    showRevisionCoursesLatest: (courseId, url, query = '') =>
      helper.get(
        `/v1/courses/${courseId}/pages/${url}/revisions/latest`,
        query,
      ),
    /**
     * Retrieve the metadata and optionally content of a revision of the page. Note that retrieving historic versions of pages requires edit rights.
     ...
     * @returns {Promise<any>}
     */
    showRevisionGroupsLatest: (groupId, url, query = '') =>
     ...
     * @returns {Promise<any>}
     */
    showRevisionCoursesRevisionId: (courseId, url, revisionId, query = '') =>
      helper.get(
        `/v1/courses/${courseId}/pages/${url}/revisions/${revisionId}`,
        query,
      ),
    /**
     * Retrieve the metadata and optionally content of a revision of the page. Note that retrieving historic versions of pages requires edit rights.
     ...
     * @returns {Promise<any>}
     */
    showRevisionGroupsRevisionId: (groupId, url, revisionId, query = '') =>
      helper.get(
        `/v1/groups/${groupId}/pages/${url}/revisions/${revisionId}`,
        query,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    revertToRevisionCourses: (courseId, url, revisionId) =>
      helper.post(
        `/v1/courses/${courseId}/pages/${url}/revisions/${revisionId}`,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    revertToRevisionGroups: (groupId, url, revisionId) =>

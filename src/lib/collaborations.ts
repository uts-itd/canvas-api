...
export default function (helper: Helper) {
  return {
     ...
     * @returns {Promise<any>}
     */
    listMembersOfCollaboration: (collaborationId: string | number, query?: any) =>
     ...
     * @returns {Promise<any>}
     */
    listPotentialMembersCourses: (courseId: string | number) =>
     ...
     * @returns {Promise<any>}
     */
    listPotentialMembersGroups: (groupId: string | number) =>

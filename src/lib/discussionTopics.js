module.exports = (helper) => {
  return {
     ...
     * @returns {Promise<any>}
     */
    listDiscussionTopicsCourses: (courseId, query = '') =>
     ...
     * @returns {Promise<any>}
     */
    listDiscussionTopicsGroups: (groupId, query = '') =>
     ...
     * @returns {Promise<any>}
     */
    createNewDiscussionTopicCourses: (courseId, body) =>
     ...
     * @returns {Promise<any>}
     */
    createNewDiscussionTopicGroups: (groupId, body) =>
     ...
     * @returns {Promise<any>}
     */
    updateTopicCourses: (courseId, topicId, body) =>
     ...
     * @returns {Promise<any>}
     */
    updateTopicGroups: (groupId, topicId, body) =>
     ...
     * @returns {Promise<any>}
     */
    deleteTopicCourses: (courseId, topicId) =>
     ...
     * @returns {Promise<any>}
     */
    deleteTopicGroups: (groupId, topicId) =>
     ...
     * @returns {Promise<any>}
     */
    reorderPinnedTopicsCourses: (courseId, body) =>
     ...
     * @returns {Promise<any>}
     */
    reorderPinnedTopicsGroups: (groupId, body) =>
     ...
     * @returns {Promise<any>}
     */
    updateEntryCourses: (courseId, topicId, entrieId, body) =>
      helper.put(
        `/v1/courses/${courseId}/discussion_topics/${topicId}/entries/${entrieId}`,
        body,
      ),
    /**
     * Update an existing discussion entry. The entry must have been created by the current user, or the current user must have admin rights to the discussion. If the edit is not allowed, a 401 will be returned.
     ...
     * @returns {Promise<any>}
     */
    updateEntryGroups: (groupId, topicId, entrieId, body) =>
      helper.put(
        `/v1/groups/${groupId}/discussion_topics/${topicId}/entries/${entrieId}`,
        body,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    deleteEntryCourses: (courseId, topicId, entrieId) =>
      helper.delete(
        `/v1/courses/${courseId}/discussion_topics/${topicId}/entries/${entrieId}`,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    deleteEntryGroups: (groupId, topicId, entrieId) =>
      helper.delete(
        `/v1/groups/${groupId}/discussion_topics/${topicId}/entries/${entrieId}`,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    getSingleTopicCourses: (courseId, topicId, query = '') =>
     ...
     * @returns {Promise<any>}
     */
    getSingleTopicGroups: (groupId, topicId, query = '') =>
     ...
     * @returns {Promise<any>}
     */
    getFullTopicCourses: (courseId, topicId) =>
     ...
     * @returns {Promise<any>}
     */
    getFullTopicGroups: (groupId, topicId) =>
     ...
     * @returns {Promise<any>}
     */
    postEntryCourses: (courseId, topicId, body) =>
      helper.post(
     ...
     * @returns {Promise<any>}
     */
    postEntryGroups: (groupId, topicId, body) =>
      helper.post(
        `/v1/groups/${groupId}/discussion_topics/${topicId}/entries`,
        body,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    listTopicEntriesCourses: (courseId, topicId) =>
      helper.get(
        `/v1/courses/${courseId}/discussion_topics/${topicId}/entries`,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    listTopicEntriesGroups: (groupId, topicId) =>
     ...
     * @returns {Promise<any>}
     */
    postReplyCourses: (courseId, topicId, entryId, body) =>
      helper.post(
     ...
     * @returns {Promise<any>}
     */
    postReplyGroups: (groupId, topicId, entryId, body) =>
      helper.post(
     ...
     * @returns {Promise<any>}
     */
    listEntryRepliesCourses: (courseId, topicId, entryId) =>
      helper.get(
        `/v1/courses/${courseId}/discussion_topics/${topicId}/entries/${entryId}/replies`,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    listEntryRepliesGroups: (groupId, topicId, entryId) =>
      helper.get(
        `/v1/groups/${groupId}/discussion_topics/${topicId}/entries/${entryId}/replies`,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    listEntriesCourses: (courseId, topicId, query = '') =>
      helper.get(
        `/v1/courses/${courseId}/discussion_topics/${topicId}/entry_list`,
        query,
      ),
    /**
     * Retrieve a paginated list of discussion entries, given a list of ids. May require (depending on the topic) that the user has posted in the topic. If it is required, and the user has not posted, will respond with a 403 Forbidden status and the body 'require_initial_post'.
     ...
     * @returns {Promise<any>}
     */
    listEntriesGroups: (groupId, topicId, query = '') =>
      helper.get(
        `/v1/groups/${groupId}/discussion_topics/${topicId}/entry_list`,
        query,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    markTopicAsReadCourses: (courseId, topicId) =>
     ...
     * @returns {Promise<any>}
     */
    markTopicAsReadGroups: (groupId, topicId) =>
     ...
     * @returns {Promise<any>}
     */
    markTopicAsUnreadCourses: (courseId, topicId) =>
      helper.delete(
        `/v1/courses/${courseId}/discussion_topics/${topicId}/read`,
      ),
    /**
     * Mark the initial text of the discussion topic as unread. No request fields are necessary. On success, the response will be 204 No Content with an empty body.
     * @summary Mark topic as unread
     ...
     * @returns {Promise<any>}
     */
    markTopicAsUnreadGroups: (groupId, topicId) =>
     ...
     * @returns {Promise<any>}
     */
    markAllEntriesAsReadCourses: (courseId, topicId, body) =>
      helper.put(
        `/v1/courses/${courseId}/discussion_topics/${topicId}/read_all`,
        body,
      ),
    /**
     * Mark the discussion topic and all its entries as read. No request fields are necessary. On success, the response will be 204 No Content with an empty body.
     ...
     * @returns {Promise<any>}
     */
    markAllEntriesAsReadGroups: (groupId, topicId, body) =>
      helper.put(
        `/v1/groups/${groupId}/discussion_topics/${topicId}/read_all`,
        body,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    markAllEntriesAsUnreadCourses: (courseId, topicId, query = '') =>
      helper.delete(
        `/v1/courses/${courseId}/discussion_topics/${topicId}/read_all`,
        query,
      ),
     ...
     * @returns {Promise<any>}
     */
    markAllEntriesAsUnreadGroups: (groupId, topicId, query = '') =>
      helper.delete(
        `/v1/groups/${groupId}/discussion_topics/${topicId}/read_all`,
        query,
      ),
     ...
     * @returns {Promise<any>}
     */
    markEntryAsReadCourses: (courseId, topicId, entryId, body) =>
      helper.put(
     ...
     * @returns {Promise<any>}
     */
    markEntryAsReadGroups: (groupId, topicId, entryId, body) =>
      helper.put(
     ...
     * @returns {Promise<any>}
     */
    markEntryAsUnreadCourses: (courseId, topicId, entryId, query = '') =>
      helper.delete(
        `/v1/courses/${courseId}/discussion_topics/${topicId}/entries/${entryId}/read`,
        query,
      ),
     ...
     * @returns {Promise<any>}
     */
    markEntryAsUnreadGroups: (groupId, topicId, entryId, query = '') =>
      helper.delete(
        `/v1/groups/${groupId}/discussion_topics/${topicId}/entries/${entryId}/read`,
        query,
      ),
     ...
     * @returns {Promise<any>}
     */
    rateEntryCourses: (courseId, topicId, entryId, body) =>
      helper.post(
     ...
     * @returns {Promise<any>}
     */
    rateEntryGroups: (groupId, topicId, entryId, body) =>
      helper.post(
     ...
     * @returns {Promise<any>}
     */
    subscribeToTopicCourses: (courseId, topicId) =>
      helper.put(
        `/v1/courses/${courseId}/discussion_topics/${topicId}/subscribed`,
      ),
    /**
     * Subscribe to a topic to receive notifications about new entries On success, the response will be 204 No Content with an empty body
     * @summary Subscribe to a topic
     ...
     * @returns {Promise<any>}
     */
    subscribeToTopicGroups: (groupId, topicId) =>
      helper.put(
        `/v1/groups/${groupId}/discussion_topics/${topicId}/subscribed`,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    unsubscribeFromTopicCourses: (courseId, topicId) =>
      helper.delete(
        `/v1/courses/${courseId}/discussion_topics/${topicId}/subscribed`,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    unsubscribeFromTopicGroups: (groupId, topicId) =>
      helper.delete(
        `/v1/groups/${groupId}/discussion_topics/${topicId}/subscribed`,
      ),
  };

...
export default function (helper: Helper) {
  return {
     ...
     * @returns {Promise<any>}
     */
    showFrontPageCourses: (courseId: string | number) => helper.get(`/v1/courses/${courseId}/front_page`),
    /**
     * Retrieve the content of the front page
     * @summary Show front page
     ...
     * @returns {Promise<any>}
     */
    showFrontPageGroups: (groupId: string | number) => helper.get(`/v1/groups/${groupId}/front_page`),
    /**
     ...
     * @returns {Promise<any>}
     */
    duplicatePage: (courseId: string | number, url: string | number) => helper.post(`/v1/courses/${courseId}/pages/${url}/duplicate`),
    /**
     ...
     * @returns {Promise<any>}
     */
    listPagesCourses: (courseId: string | number, query?: any) => helper.get(`/v1/courses/${courseId}/pages`, query),
    /**
     * A paginated list of the wiki pages associated with a course or group
     * @summary List pages
     * @param {string|number} groupId Canvas Group ID
     ...
     * @returns {Promise<any>}
     */
    listPagesGroups: (groupId: string | number, query?: any) => helper.get(`/v1/groups/${groupId}/pages`, query),
    /**
     ...
     * @returns {Promise<any>}
     */
    createPageCourses: (courseId: string | number, body: any) => helper.post(`/v1/courses/${courseId}/pages`, body),
    /**
     * Create a new wiki page
     * @summary Create page
     * @param {string|number} groupId Canvas Group ID
     ...
     * @returns {Promise<any>}
     */
    createPageGroups: (groupId: string | number, body: any) => helper.post(`/v1/groups/${groupId}/pages`, body),
    /**
     ...
     * @returns {Promise<any>}
     */
    showPageCourses: (courseId: string | number, url: string | number) => helper.get(`/v1/courses/${courseId}/pages/${url}`),
    /**
     * Retrieve the content of a wiki page
     * @summary Show page
     * @param {string|number} groupId Canvas Group ID
     ...
     * @returns {Promise<any>}
     */
    showPageGroups: (groupId: string | number, url: string | number) => helper.get(`/v1/groups/${groupId}/pages/${url}`),
    /**
     ...
     * @returns {Promise<any>}
     */
    deletePageCourses: (courseId: string | number, url: string | number) => helper.delete(`/v1/courses/${courseId}/pages/${url}`),
    /**
     * Delete a wiki page
     * @summary Delete page
     * @param {string|number} groupId Canvas Group ID
     ...
     * @returns {Promise<any>}
     */
    deletePageGroups: (groupId: string | number, url: string | number) => helper.delete(`/v1/groups/${groupId}/pages/${url}`),
    /**
     ...
     * @returns {Promise<any>}
     */
    showRevisionCoursesRevisionId: (courseId: string | number, url: string | number, revisionId: string | number, query?: any) =>
     ...
     * @returns {Promise<any>}
     */
    showRevisionGroupsRevisionId: (groupId: string | number, url: string | number, revisionId: string | number, query?: any) =>
     ...
     * @returns {Promise<any>}
     */
    revertToRevisionCourses: (courseId: string | number, url: string | number, revisionId: string | number) =>
     ...
     * @returns {Promise<any>}
     */
    revertToRevisionGroups: (groupId: string | number, url: string | number, revisionId: string | number) =>

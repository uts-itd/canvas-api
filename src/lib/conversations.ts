...
export default function (helper: Runner) {
  return {
     ...
     * @returns {Promise<any>}
     */
    listConversations: (query?: any) => helper.get(`/v1/conversations`, query),
    /**
     ...
     * @returns {Promise<any>}
     */
    createConversation: (body: any) => helper.post(`/v1/conversations`, body),
    /**
     ...
     * @returns {Promise<any>}
     */
    getRunningBatches: () => helper.get(`/v1/conversations/batches`),
    /**
     ...
     * @returns {Promise<any>}
     */
    getSingleConversation: (conversationId: string | number, query?: any) =>
     ...
     * @returns {Promise<any>}
     */
    editConversation: (conversationId: string | number, body: any) =>
     ...
     * @returns {Promise<any>}
     */
    markAllAsRead: () => helper.post(`/v1/conversations/mark_all_as_read`),
    /**
     ...
     * @returns {Promise<any>}
     */
    addRecipients: (conversationId: string | number, body: any) =>
     ...
     * @returns {Promise<any>}
     */
    addMessage: (conversationId: string | number, body: any) =>
     ...
     * @returns {Promise<any>}
     */
    deleteMessage: (conversationId: string | number, body: any) =>
     ...
     * @returns {Promise<any>}
     */
    batchUpdateConversations: (body: any) => helper.put(`/v1/conversations`, body),
    /**
     * Deprecated, see the {api:SearchController#recipients Find recipients endpoint} in the Search API
     * @summary Find recipients
     * @returns {Promise<any>}
     */
    findRecipients: () => helper.get(`/v1/conversations/find_recipients`),
    /**

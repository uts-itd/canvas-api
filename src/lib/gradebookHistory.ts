...
export default function (helper: Helper) {
  return {
     ...
     * @returns {Promise<any>}
     */
    daysInGradebookHistoryForThisCourse: (courseId: string | number) =>
      helper.get(`/v1/courses/${courseId}/gradebook_history/days`),
    /**
     ...
     * @returns {Promise<any>}
     */
    detailsForGivenDateInGradebookHistoryForThisCourse: (courseId: string | number, date: string) =>
      helper.get(`/v1/courses/${courseId}/gradebook_history/${date}`),
    /**
     ...
     * @returns {Promise<any>}
     */
    listUncollatedSubmissionVersions: (courseId: string | number, query?: any) =>
      helper.get(`/v1/courses/${courseId}/gradebook_history/feed`, query),
  };
}

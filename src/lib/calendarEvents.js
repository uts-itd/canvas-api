module.exports = (helper) => {
  return {
    ...
    listCalendarEvents: (query = '') =>
      helper.get(`/v1/calendar_events`, query),
    /**
     ...
     * @returns {Promise<any>}
     */
    listCalendarEventsForUser: (userId, query = '') =>
     ...
     * @returns {Promise<any>}
     */
    createCalendarEvent: (body) => helper.post(`/v1/calendar_events`, body),
    /**
     *
     ...
     * @returns {Promise<any>}
     */
    getSingleCalendarEventOrAssignment: (calendarEventId) =>
     ...
     * @returns {Promise<any>}
     */
    reserveTimeSlot: (calendarEventId, body) =>
     ...
     * @returns {Promise<any>}
     */
    reserveTimeSlotParticipantId: (calendarEventId, participantId, body) =>
      helper.post(
        `/v1/calendar_events/${calendarEventId}/reservations/${participantId}`,
        body,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    updateCalendarEvent: (calendarEventId, body) =>
     ...
     * @returns {Promise<any>}
     */
    deleteCalendarEvent: (calendarEventId, query = '') =>
     ...
     * @returns {Promise<any>}
     */
    setCourseTimetable: (courseId, body) =>
     ...
     * @returns {Promise<any>}
     */
    createOrUpdateEventsDirectlyForCourseTimetable: (courseId, body) =>
      helper.post(
        `/v1/courses/${courseId}/calendar_events/timetable_events`,
        body,
      ),
  };
};

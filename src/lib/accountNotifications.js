module.exports = (helper) => {
  return {
     ...
     * @returns {Promise<any>}
     */
    indexOfActiveGlobalNotificationForUser: (accountId) =>
     ...
     * @returns {Promise<any>}
     */
    showGlobalNotification: (accountId, accountNotificationId) =>
      helper.get(
        `/v1/accounts/${accountId}/account_notifications/${accountNotificationId}`,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    closeNotificationForUser: (accountId, accountNotificationId) =>
      helper.delete(
        `/v1/accounts/${accountId}/account_notifications/${accountNotificationId}`,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    createGlobalNotification: (accountId, body) =>
     ...
     * @returns {Promise<any>}
     */
    updateGlobalNotification: (accountId, accountNotificationId, body) =>
      helper.put(
        `/v1/accounts/${accountId}/account_notifications/${accountNotificationId}`,
        body,
      ),

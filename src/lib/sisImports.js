module.exports = (helper) => {
  return {
     ...
     * @returns {Promise<any>}
     */
    getSisImportList: (accountId, query = '') =>
     ...
     * @returns {Promise<any>}
     */
    getSisImportStatus: (accountId, sisImportId) =>
     ...
     * @returns {Promise<any>}
     */
    restoreWorkflowStatesOfSisImportedItems: (accountId, sisImportId, body) =>
      helper.put(
        `/v1/accounts/${accountId}/sis_imports/${sisImportId}/restore_states`,
        body,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    abortSisImport: (accountId, sisImportId) =>
     ...
     * @returns {Promise<any>}
     */
    abortAllPendingSisImports: (accountId) =>

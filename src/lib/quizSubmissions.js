module.exports = (helper) => {
  return {
     ...
     * @returns {Promise<any>}
     */
    getAllQuizSubmissions: (courseId, quizId, query = '') =>
      helper.get(
     ...
     * @returns {Promise<any>}
     */
    getQuizSubmission: (courseId, quizId, query = '') =>
     ...
     * @returns {Promise<any>}
     */
    getSingleQuizSubmission: (courseId, quizId, submissionId, query = '') =>
      helper.get(
        `/v1/courses/${courseId}/quizzes/${quizId}/submissions/${submissionId}`,
        query,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    createQuizSubmissionStartQuizTakingSession: (courseId, quizId, body) =>
      helper.post(
        `/v1/courses/${courseId}/quizzes/${quizId}/submissions`,
        body,
      ),
     ...
     * @returns {Promise<any>}
     */
    completeQuizSubmissionTurnItIn: (courseId, quizId, submissionId, body) =>
      helper.post(
     ...
     * @returns {Promise<any>}
     */
    getCurrentQuizSubmissionTimes: (courseId, quizId, submissionId) =>
      helper.get(
        `/v1/courses/${courseId}/quizzes/${quizId}/submissions/${submissionId}/time`,
      ),
  };
};

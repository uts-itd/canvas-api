module.exports = (helper) => {
  return {
     ...
     * @returns {Promise<any>}
     */
    listMigrationIssuesAccounts: (accountId, contentMigrationId) =>
      helper.get(
     ...
     * @returns {Promise<any>}
     */
    listMigrationIssuesCourses: (courseId, contentMigrationId) =>
      helper.get(
     ...
     * @returns {Promise<any>}
     */
    listMigrationIssuesGroups: (groupId, contentMigrationId) =>
      helper.get(
        `/v1/groups/${groupId}/content_migrations/${contentMigrationId}/migration_issues`,
      ),
    /**
     * Returns paginated migration issues
     * @summary List migration issues
     ...
     * @returns {Promise<any>}
     */
    listMigrationIssuesUsers: (userId, contentMigrationId) =>
      helper.get(
        `/v1/users/${userId}/content_migrations/${contentMigrationId}/migration_issues`,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    getMigrationIssueGroups: (groupId, contentMigrationId, migrationIssueId) =>
      helper.get(
     ...
     * @returns {Promise<any>}
     */
    getMigrationIssueUsers: (userId, contentMigrationId, migrationIssueId) =>
      helper.get(
     ...
     * @returns {Promise<any>}
     */
    listContentMigrationsAccounts: (accountId) =>
     ...
     * @returns {Promise<any>}
     */
    listContentMigrationsCourses: (courseId) =>
     ...
     * @returns {Promise<any>}
     */
    listContentMigrationsGroups: (groupId) =>
     ...
     * @returns {Promise<any>}
     */
    listContentMigrationsUsers: (userId) =>
     ...
     * @returns {Promise<any>}
     */
    getContentMigrationAccounts: (accountId, contentMigrationId) =>
      helper.get(
        `/v1/accounts/${accountId}/content_migrations/${contentMigrationId}`,
      ),
    /**
     * Returns data on an individual content migration
     * @summary Get a content migration
     ...
     * @returns {Promise<any>}
     */
    getContentMigrationCourses: (courseId, contentMigrationId) =>
      helper.get(
        `/v1/courses/${courseId}/content_migrations/${contentMigrationId}`,
      ),
    /**
     * Returns data on an individual content migration
     * @summary Get a content migration
     ...
     * @returns {Promise<any>}
     */
    getContentMigrationGroups: (groupId, contentMigrationId) =>
      helper.get(
        `/v1/groups/${groupId}/content_migrations/${contentMigrationId}`,
      ),
    /**
     * Returns data on an individual content migration
     * @summary Get a content migration
     ...
     * @returns {Promise<any>}
     */
    getContentMigrationUsers: (userId, contentMigrationId) =>
      helper.get(
        `/v1/users/${userId}/content_migrations/${contentMigrationId}`,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    createContentMigrationAccounts: (accountId, body) =>
     ...
     * @returns {Promise<any>}
     */
    createContentMigrationCourses: (courseId, body) =>
     ...
     * @returns {Promise<any>}
     */
    createContentMigrationGroups: (groupId, body) =>
     ...
     * @returns {Promise<any>}
     */
    createContentMigrationUsers: (userId, body) =>
     ...
     * @returns {Promise<any>}
     */
    updateContentMigrationAccounts: (accountId, contentMigrationId) =>
      helper.put(
        `/v1/accounts/${accountId}/content_migrations/${contentMigrationId}`,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    updateContentMigrationCourses: (courseId, contentMigrationId) =>
      helper.put(
        `/v1/courses/${courseId}/content_migrations/${contentMigrationId}`,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    updateContentMigrationGroups: (groupId, contentMigrationId) =>
      helper.put(
        `/v1/groups/${groupId}/content_migrations/${contentMigrationId}`,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    updateContentMigrationUsers: (userId, contentMigrationId) =>
      helper.put(
        `/v1/users/${userId}/content_migrations/${contentMigrationId}`,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    listMigrationSystemsAccounts: (accountId) =>
     ...
     * @returns {Promise<any>}
     */
    listMigrationSystemsCourses: (courseId) =>
     ...
     * @returns {Promise<any>}
     */
    listMigrationSystemsGroups: (groupId) =>
     ...
     * @returns {Promise<any>}
     */
    listMigrationSystemsUsers: (userId) =>

...
export default function (helper: Runner) {
  return {
     ...
     * @returns {Promise<any>}
     */
    listUsersInAccount: (accountId: string | number, query?: any) =>
      helper.get(`/v1/accounts/${accountId}/users`, query),
    /**
     ...
     * @returns {Promise<any>}
     */
    listMissingSubmissions: (userId: string | number, query?: any) =>
      helper.get(`/v1/users/${userId}/missing_submissions`, query),
    /**
     * Hide the given stream item.
     * @summary Hide a stream item
     * @param {string|number} activityStreaId Canvas Activity strea ID
     * @returns {Promise<any>}
     */
    hideStreamItem: (activityStreaId: string | number) =>
      helper.delete(`/v1/users/self/activity_stream/${activityStreaId}`),
    /**
    ...
    terminateAllUserSessions: (userId: string | number) =>
      helper.delete(`/v1/users/${userId}/sessions`),
    /**
     ...
     * @returns {Promise<any>}
     */
    uploadFile: (userId: string | number) => helper.post(`/v1/users/${userId}/files`),
    /**
     ...
     * @returns {Promise<any>}
     */
    showUserDetails: (userId: string | number) => helper.get(`/v1/users/${userId}`),
    /**
     ...
     * @returns {Promise<any>}
     */
    createUser: (accountId: string | number, body: any) =>
      helper.post(`/v1/accounts/${accountId}/users`, body),
    /**
     ...
     * @returns {Promise<any>}
     */
    selfRegisterUser: (accountId: string | number, body: any) =>
      helper.post(`/v1/accounts/${accountId}/self_registration`, body),
    /**
     ...
     * @returns {Promise<any>}
     */
    updateUserSettings: (userId: string | number, query?: any) =>
      helper.get(`/v1/users/${userId}/settings`, query),
    /**
     ...
     * @returns {Promise<any>}
     */
    getCustomColors: (userId: string | number) => helper.get(`/v1/users/${userId}/colors`),
    /**
     ...
     * @param {string|number} userId Canvas User ID
     * @param {string|number} assetString ID
     * @returns {Promise<any>}
     */
    getCustomColor: (userId: string | number, assetString: string) =>
      helper.get(`/v1/users/${userId}/colors/${assetString}`),
    /**
     ...
     * @returns {Promise<any>}
     */
    updateCustomColor: (userId: string | number, assetString: string, body: any) =>
      helper.put(`/v1/users/${userId}/colors/${assetString}`, body),
    /**
     ...
     * @returns {Promise<any>}
     */
    getDashboardPositions: (userId: string | number) =>
      helper.get(`/v1/users/${userId}/dashboard_positions`),
    /**
     ...
     * @returns {Promise<any>}
     */
    updateDashboardPositions: (userId: string | number) =>
      helper.put(`/v1/users/${userId}/dashboard_positions`),
    /**
     ...
     * @returns {Promise<any>}
     */
    editUser: (userId: string | number, body: any) => helper.put(`/v1/users/${userId}`, body),
    /**
     ...
     * @param {string|number} userId Canvas User ID
     * @param {string|number} destinationUserId Canvas Destination user ID
     * @returns {Promise<any>}
     */
    mergeUserIntoAnotherUserDestinationUserId: (
      userId: string | number,
      destinationUserId: string | number,
    ) => helper.put(`/v1/users/${userId}/merge_into/${destinationUserId}`),
    /**
     * Merge a user into another user. To merge users, the caller must have permissions to manage both users. This should be considered irreversible. This will delete the user and move all the data into the destination user. When finding users by SIS ids in different accounts the destination_account_id is required. The account can also be identified by passing the domain in destination_account_id.
     * @summary Merge user into another user
     * @param {string|number} userId Canvas User ID
     * @param {string|number} destinationAccountId Canvas Destination account ID
     * @param {string|number} destinationUserId Canvas Destination user ID
     * @returns {Promise<any>}
     */
    mergeUserIntoAnotherUserAccounts: (
      userId: string | number,
      destinationAccountId: string | number,
      destinationUserId: string | number,
    ) =>
      helper.put(
        `/v1/users/${userId}/merge_into/accounts/${destinationAccountId}/users/${destinationUserId}`,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    splitMergedUsersIntoSeparateUsers: (userId: string | number) =>
      helper.post(`/v1/users/${userId}/split`),
    /**
     ...
     * @returns {Promise<any>}
     */
    getUserProfile: (userId: string | number) => helper.get(`/v1/users/${userId}/profile`),
    /**
     ...
     * @returns {Promise<any>}
     */
    listAvatarOptions: (userId: string | number) => helper.get(`/v1/users/${userId}/avatars`),
    /**
     ...
     * @returns {Promise<any>}
     */
    deleteCustomData: (userId: string | number, query: any, scope = '') =>
      helper.delete(`/v1/users/${userId}/custom_data/${scope}`, query),
    /**
     ...
     * @returns {Promise<any>}
     */
    getCourseNickname: (courseId: string | number) =>
      helper.get(`/v1/users/self/course_nicknames/${courseId}`),
    /**
     ...
     * @returns {Promise<any>}
     */
    setCourseNickname: (courseId: string | number, body: any) =>
      helper.put(`/v1/users/self/course_nicknames/${courseId}`, body),
    /**
     ...
     * @returns {Promise<any>}
     */
    removeCourseNickname: (courseId: string | number) =>
      helper.delete(`/v1/users/self/course_nicknames/${courseId}`),
    /**

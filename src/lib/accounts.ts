...
export default function (helper: Runner) {
  return {
     ...
     * @returns {Promise<any>}
     */
    getSingleAccount: (accountId: string | number) => helper.get(`/v1/accounts/${accountId}`),
    /**
     ...
     * @returns {Promise<any>}
     */
    permissions: (accountId: string | number, query?: any) =>
     ...
     * @returns {Promise<any>}
     */
    getSubAccountsOfAccount: (accountId: string | number, query?: any) =>
     ...
     * @returns {Promise<any>}
     */
    returnsTermsOfServiceForThatAccount: (accountId: string | number) =>
     ...
     * @returns {Promise<any>}
     */
    listActiveCoursesInAccount: (accountId: string | number, query?: any) =>
     ...
     * @returns {Promise<any>}
     */
    updateAccount: (accountId: string | number, body: any) =>
     ...
     * @returns {Promise<any>}
     */
    deleteUserFromRootAccount: (accountId: string | number, userId: string | number) =>
     ...
     * @returns {Promise<any>}
     */
    createNewSubAccount: (accountId: string | number, body: any) =>
     ...
     * @returns {Promise<any>}
     */
    deleteSubAccount: (accountId: string | number, subAccountId: string | number) =>

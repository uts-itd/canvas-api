module.exports = (helper) => {
  return {
     ...
     * @returns {Promise<any>}
     */
    getSingleRubricAccounts: (accountId, rubricId, query = '') =>
     ...
     * @returns {Promise<any>}
     */
    getSingleRubricCourses: (courseId, rubricId, query = '') =>

module.exports = (helper) => {
  return {
     ...
     * @returns {Promise<any>}
     */
    createLiveAssessmentResults: (courseId, assessmentId) =>
      helper.post(
        `/v1/courses/${courseId}/live_assessments/${assessmentId}/results`,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    listLiveAssessmentResults: (courseId, assessmentId, query = '') =>
      helper.get(
        `/v1/courses/${courseId}/live_assessments/${assessmentId}/results`,
        query,
      ),
     ...
     * @returns {Promise<any>}
     */
    createOrFindLiveAssessment: (courseId) =>

module.exports = (helper) => {
  return {
    ...
    deleteAssignment: (courseId, assignmentId) =>
      helper.delete(`/v1/courses/${courseId}/assignments/${assignmentId}`),
    /**
     ...
     * @returns {Promise<any>}
     */
    listAssignments: (courseId, query = '') =>
      helper.get(`/v1/courses/${courseId}/assignments`, query),
    /**
     ...
     * @returns {Promise<any>}
     */
    listAssignmentsForUser: (userId, courseId) =>
      helper.get(`/v1/users/${userId}/courses/${courseId}/assignments`),
    /**
     ...
     * @returns {Promise<any>}
     */
    getSingleAssignment: (courseId, assignmentId, query = '') =>
      helper.get(`/v1/courses/${courseId}/assignments/${assignmentId}`, query),
    /**
    ...
    createAssignment: (courseId, body) =>
      helper.post(`/v1/courses/${courseId}/assignments`, body),
    /**
     ...
     * @returns {Promise<any>}
     */
    editAssignment: (courseId, assignmentId, body) =>
      helper.put(`/v1/courses/${courseId}/assignments/${assignmentId}`, body),
    /**
     ...
     * @returns {Promise<any>}
     */
    listAssignmentOverrides: (courseId, assignmentId) =>
      helper.get(
        `/v1/courses/${courseId}/assignments/${assignmentId}/overrides`,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    getSingleAssignmentOverride: (courseId, assignmentId, overrideId) =>
      helper.get(
     ...
     * @returns {Promise<any>}
     */
    redirectToAssignmentOverrideForGroup: (groupId, assignmentId) =>
     ...
     * @returns {Promise<any>}
     */
    redirectToAssignmentOverrideForSection: (courseSectionId, assignmentId) =>
      helper.get(
        `/v1/sections/${courseSectionId}/assignments/${assignmentId}/override`,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    createAssignmentOverride: (courseId, assignmentId, body) =>
      helper.post(
        `/v1/courses/${courseId}/assignments/${assignmentId}/overrides`,
        body,
      ),
     ...
     * @returns {Promise<any>}
     */
    updateAssignmentOverride: (courseId, assignmentId, overrideId, body) =>
      helper.put(
        `/v1/courses/${courseId}/assignments/${assignmentId}/overrides/${overrideId}`,
        body,
      ),
     ...
     * @returns {Promise<any>}
     */
    deleteAssignmentOverride: (courseId, assignmentId, overrideId) =>
      helper.delete(
        `/v1/courses/${courseId}/assignments/${assignmentId}/overrides/${overrideId}`,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    batchRetrieveOverridesInCourse: (courseId, query) =>
      helper.get(`/v1/courses/${courseId}/assignments/overrides`, query),
    /**
     ...
     * @returns {Promise<any>}
     */
    batchCreateOverridesInCourse: (courseId, body) =>
      helper.post(`/v1/courses/${courseId}/assignments/overrides`, body),
    /**
     ...
     * @returns {Promise<any>}
     */
    batchUpdateOverridesInCourse: (courseId, body) =>
      helper.put(`/v1/courses/${courseId}/assignments/overrides`, body),
  };
};

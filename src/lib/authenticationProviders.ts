...
export default function (helper: Runner) {
  return {
     ...
     * @returns {Promise<any>}
     */
    showAccountAuthSettings: (accountId: string | number) =>
      helper.get(`/v1/accounts/${accountId}/sso_settings`),
    /**
     ...
     * @returns {Promise<any>}
     */
    updateAccountAuthSettings: (accountId: string | number) =>
      helper.put(`/v1/accounts/${accountId}/sso_settings`),
  };
}

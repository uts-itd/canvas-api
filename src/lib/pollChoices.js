module.exports = (helper) => {
  return {
     ...
     * @returns {Promise<any>}
     */
    getSinglePollChoice: (pollId, pollChoiceId) =>
     ...
     * @returns {Promise<any>}
     */
    createSinglePollChoice: (pollId, body) =>
     ...
     * @returns {Promise<any>}
     */
    updateSinglePollChoice: (pollId, pollChoiceId, body) =>
     ...
     * @returns {Promise<any>}
     */
    deletePollChoice: (pollId, pollChoiceId) =>

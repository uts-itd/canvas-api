module.exports = (helper) => {
  return {
     ...
     * @returns {Promise<any>}
     */
    listEnrollmentsCourses: (courseId, query = '') =>
     ...
     * @returns {Promise<any>}
     */
    listEnrollmentsSections: (sectionId, query = '') =>
     ...
     * @returns {Promise<any>}
     */
    listEnrollmentsUsers: (userId, query = '') =>
     ...
     * @returns {Promise<any>}
     */
    enrollmentById: (accountId, enrollmentId) =>
     ...
     * @returns {Promise<any>}
     */
    enrollUserCourses: (courseId, body) =>
     ...
     * @returns {Promise<any>}
     */
    enrollUserSections: (sectionId, body) =>
     ...
     * @returns {Promise<any>}
     */
    acceptCourseInvitation: (courseId, enrollmentId) =>
     ...
     * @returns {Promise<any>}
     */
    rejectCourseInvitation: (courseId, enrollmentId) =>
     ...
     * @returns {Promise<any>}
     */
    reActivateEnrollment: (courseId, enrollmentId) =>
      helper.put(
        `/v1/courses/${courseId}/enrollments/${enrollmentId}/reactivate`,
      ),
    /**
     *
     ...
     * @returns {Promise<any>}
     */
    addsLastAttendedDateToStudentEnrollmentInCourse: (courseId, userId) =>

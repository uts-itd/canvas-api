module.exports = (helper) => {
  return {
     ...
     * @returns {Promise<any>}
     */
    listQuizzesInCourse: (courseId, query = '') =>
     ...
     * @returns {Promise<any>}
     */
    getSingleQuiz: (courseId, quizzeId) =>
     ...
     * @returns {Promise<any>}
     */
    editQuiz: (courseId, quizzeId, body) =>
     ...
     * @returns {Promise<any>}
     */
    reorderQuizItems: (courseId, quizzeId, body) =>
     ...
     * @returns {Promise<any>}
     */
    validateQuizAccessCode: (courseId, quizzeId, body) =>
      helper.post(
        `/v1/courses/${courseId}/quizzes/${quizzeId}/validate_access_code`,
        body,
      ),
  };
};

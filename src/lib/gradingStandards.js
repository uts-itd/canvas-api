module.exports = (helper) => {
  return {
     ...
     * @returns {Promise<any>}
     */
    createNewGradingStandardAccounts: (accountId, body) =>
     ...
     * @returns {Promise<any>}
     */
    createNewGradingStandardCourses: (courseId, body) =>
     ...
     * @returns {Promise<any>}
     */
    listGradingStandardsAvailableInContextCourses: (courseId) =>
     ...
     * @returns {Promise<any>}
     */
    listGradingStandardsAvailableInContextAccounts: (accountId) =>
     ...
     * @returns {Promise<any>}
     */
    getSingleGradingStandardInContextCourses: (courseId, gradingStandardId) =>
      helper.get(
        `/v1/courses/${courseId}/grading_standards/${gradingStandardId}`,
      ),
    /**
     * Returns a grading standard for the given context that is visible to the user.
     * @summary Get a single grading standard in a context.
     ...
     * @returns {Promise<any>}
     */
    getSingleGradingStandardInContextAccounts: (accountId, gradingStandardId) =>
      helper.get(
        `/v1/accounts/${accountId}/grading_standards/${gradingStandardId}`,
      ),
  };
};

...
export default function (helper: Runner) {
  return {
     ...
     * @returns {Promise<any>}
     */
    deleteWebhookSubscription: (subscriptionId: string | number) =>
     ...
     * @returns {Promise<any>}
     */
    showSingleWebhookSubscription: (subscriptionId: string | number) =>
     ...
     * @returns {Promise<any>}
     */
    updateWebhookSubscription: (subscriptionId: string | number) =>

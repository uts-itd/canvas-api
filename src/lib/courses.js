module.exports = (helper) => {
  return {
     ...
     * @returns {Promise<any>}
     */
    listCoursesForUser: (userId, query = '') =>
     ...
     * @returns {Promise<any>}
     */
    createNewCourse: (accountId, body) =>
     ...
     * @returns {Promise<any>}
     */
    listUsersInCourseUsers: (courseId, query = '') =>
     ...
     * @returns {Promise<any>}
     */
    listUsersInCourseSearchUsers: (courseId, query = '') =>
     ...
     * @returns {Promise<any>}
     */
    listRecentlyLoggedInStudents: (courseId) =>
     ...
     * @returns {Promise<any>}
     */
    previewProcessedHtml: (courseId, body) =>
     ...
     * @returns {Promise<any>}
     */
    courseActivityStreamSummary: (courseId) =>
     ...
     * @returns {Promise<any>}
     */
    deleteConcludeCourse: (courseId, query) =>
     ...
     * @returns {Promise<any>}
     */
    updateCourseSettings: (courseId, body) =>
     ...
     * @returns {Promise<any>}
     */
    getSingleCourseCourses: (courseId, query = '') =>
     ...
     * @returns {Promise<any>}
     */
    getSingleCourseAccounts: (accountId, courseId, query = '') =>
     ...
     * @returns {Promise<any>}
     */
    getEffectiveDueDates: (courseId, query = '') =>
     ...
     * @returns {Promise<any>}
     */
    getCourseCopyStatus: (courseId, courseCopId) =>
     ...
     * @returns {Promise<any>}
     */
    copyCourseContent: (courseId, body) =>

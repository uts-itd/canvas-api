...
export default function (helper: Runner) {
  return {
     ...
     * @returns {Promise<any>}
     */
    listObservees: (userId: string | number, query?: any) =>
     ...
     * @returns {Promise<any>}
     */
    addObserveeWithCredentials: (userId: string | number, body: any) =>
     ...
     * @returns {Promise<any>}
     */
    showObservee: (userId: string | number, observeeId: string | number) =>
     ...
     * @returns {Promise<any>}
     */
    addObservee: (userId: string | number, observeeId: string | number, body: any) =>
     ...
     * @returns {Promise<any>}
     */
    removeObservee: (userId: string | number, observeeId: string | number, query?: any) =>

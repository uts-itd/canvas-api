...
export default function (helper: Runner) {
  return {
     ...
     * @returns {Promise<any>}
     */
    getAllQuizSubmissions: (courseId: string | number, quizId: string | number, query?: any) =>
      helper.get(`/v1/courses/${courseId}/quizzes/${quizId}/submissions`, query),
    /**
     ...
     * @returns {Promise<any>}
     */
    getQuizSubmission: (courseId: string | number, quizId: string | number, query?: any) =>
      helper.get(`/v1/courses/${courseId}/quizzes/${quizId}/submission`, query),
    /**
    ...
    getSingleQuizSubmission: (
      ...
      query?: any,
    ) => helper.get(`/v1/courses/${courseId}/quizzes/${quizId}/submissions/${submissionId}`, query),
    /**
    ...
    createQuizSubmissionStartQuizTakingSession: (
      ...
      quizId: string | number,
      body: any,
    ) => helper.post(`/v1/courses/${courseId}/quizzes/${quizId}/submissions`, body),
    /**
    ...
    updateStudentQuestionScoresAndComments: (
      ...
      submissionId: string | number,
      body: any,
    ) => helper.put(`/v1/courses/${courseId}/quizzes/${quizId}/submissions/${submissionId}`, body),
    /**
    ...
    getCurrentQuizSubmissionTimes: (
      ...
      quizId: string | number,
      submissionId: string | number,
    ) => helper.get(`/v1/courses/${courseId}/quizzes/${quizId}/submissions/${submissionId}/time`),
  };
}

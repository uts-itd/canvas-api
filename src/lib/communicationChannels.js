module.exports = (helper) => {
  return {
     ...
     * @returns {Promise<any>}
     */
    listUserCommunicationChannels: (userId) =>
     ...
     * @returns {Promise<any>}
     */
    createCommunicationChannel: (userId, body) =>
     ...
     * @returns {Promise<any>}
     */
    deleteCommunicationChannelId: (userId, communicationChannelId) =>
      helper.delete(
        `/v1/users/${userId}/communication_channels/${communicationChannelId}`,
      ),
    /**
     * Delete an existing communication channel.
     * @summary Delete a communication channel
     ...
     * @returns {Promise<any>}
     */
    deleteCommunicationChannelType: (userId, type, address) =>
      helper.delete(
        `/v1/users/${userId}/communication_channels/${type}/${address}`,
      ),
    /**
     *

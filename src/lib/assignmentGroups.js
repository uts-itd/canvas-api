module.exports = (helper) => {
  return {
     ...
     * @returns {Promise<any>}
     */
    listAssignmentGroups: (courseId, query = '') =>
     ...
     * @returns {Promise<any>}
     */
    getAssignmentGroup: (courseId, assignmentGroupId, query = '') =>
      helper.get(
        `/v1/courses/${courseId}/assignment_groups/${assignmentGroupId}`,
        query,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    createAssignmentGroup: (courseId, body) =>
     ...
     * @returns {Promise<any>}
     */
    editAssignmentGroup: (courseId, assignmentGroupId) =>
      helper.put(
        `/v1/courses/${courseId}/assignment_groups/${assignmentGroupId}`,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    destroyAssignmentGroup: (courseId, assignmentGroupId, query = '') =>
      helper.delete(
        `/v1/courses/${courseId}/assignment_groups/${assignmentGroupId}`,
        query,
      ),

module.exports = (helper) => {
  return {
     ...
     * @returns {Promise<any>}
     */
    showModule: (courseId, moduleId, query = '') =>
      helper.get(`/v1/courses/${courseId}/modules/${moduleId}`, query),
    /**
    ...
    updateModule: (courseId, moduleId, body) =>
      helper.put(`/v1/courses/${courseId}/modules/${moduleId}`, body),
    /**
     * Delete a module
    ...
    deleteModule: (courseId, moduleId) =>
      helper.delete(`/v1/courses/${courseId}/modules/${moduleId}`),
    /**
     ...
     * @returns {Promise<any>}
     */
    reLockModuleProgressions: (courseId, moduleId) =>
      helper.put(`/v1/courses/${courseId}/modules/${moduleId}/relock`),
    /**
     ...
     * @returns {Promise<any>}
     */
    listModuleItems: (courseId, moduleId, query = '') =>
      helper.get(`/v1/courses/${courseId}/modules/${moduleId}/items`, query),
    /**
     ...
     * @returns {Promise<any>}
     */
    showModuleItem: (courseId, moduleId, itemId, query = '') =>
      helper.get(
        `/v1/courses/${courseId}/modules/${moduleId}/items/${itemId}`,
        query,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    createModuleItem: (courseId, moduleId, body) =>
      helper.post(`/v1/courses/${courseId}/modules/${moduleId}/items`, body),
    /**
     ...
     * @returns {Promise<any>}
     */
    updateModuleItem: (courseId, moduleId, itemId, body) =>
      helper.put(
        `/v1/courses/${courseId}/modules/${moduleId}/items/${itemId}`,
        body,
      ),
     ...
     * @returns {Promise<any>}
     */
    selectMasteryPath: (courseId, moduleId, itemId, body) =>
      helper.post(
     ...
     * @returns {Promise<any>}
     */
    markModuleItemAsDoneNotDone: (courseId, moduleId, itemId) =>
      helper.put(
     ...
     * @returns {Promise<any>}
     */
    getModuleItemSequence: (courseId, query = '') =>
      helper.get(`/v1/courses/${courseId}/module_item_sequence`, query),
    /**
     ...
     * @returns {Promise<any>}
     */
    markModuleItemRead: (courseId, moduleId, itemId) =>
      helper.post(
        `/v1/courses/${courseId}/modules/${moduleId}/items/${itemId}/mark_read`,
      ),
  };
};

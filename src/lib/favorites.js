module.exports = (helper) => {
  return {
     ...
     * @returns {Promise<any>}
     */
    listFavoriteCourses: (query = '') =>
      helper.get(`/v1/users/self/favorites/courses`, query),
    /**
     ...
     * @returns {Promise<any>}
     */
    removeGroupFromFavorites: (groupId) =>
     ...
     * @returns {Promise<any>}
     */
    resetCourseFavorites: () =>
      helper.delete(`/v1/users/self/favorites/courses`),
    /**

...
export default function (helper: Helper) {
  return {
     ...
     * @returns {Promise<any>}
     */
    getBlueprintInformation: (courseId: string | number, templateId: string | number) =>
     ...
     * @returns {Promise<any>}
     */
    getAssociatedCourseInformation: (courseId: string | number, templateId: string | number) =>
      helper.get(`/v1/courses/${courseId}/blueprint_templates/${templateId}/associated_courses`),
    /**
     ...
     * @returns {Promise<any>}
     */
    updateAssociatedCourses: (courseId: string | number, templateId: string | number, body: any) =>
      helper.put(
     ...
     * @returns {Promise<any>}
     */
    getUnsyncedChanges: (courseId: string | number, templateId: string | number) =>
      helper.get(`/v1/courses/${courseId}/blueprint_templates/${templateId}/unsynced_changes`),
    /**
     ...
     * @returns {Promise<any>}
     */
    listBlueprintMigrations: (courseId: string | number, templateId: string | number) =>
      helper.get(`/v1/courses/${courseId}/blueprint_templates/${templateId}/migrations`),
    /**
     ...
     * @returns {Promise<any>}
     */
    listBlueprintImports: (courseId: string | number, subscriptionId: string | number) =>
      helper.get(`/v1/courses/${courseId}/blueprint_subscriptions/${subscriptionId}/migrations`),
    /**

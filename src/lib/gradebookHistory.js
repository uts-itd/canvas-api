module.exports = (helper) => {
  return {
     ...
     * @returns {Promise<any>}
     */
    daysInGradebookHistoryForThisCourse: (courseId) =>
     ...
     * @returns {Promise<any>}
     */
    detailsForGivenDateInGradebookHistoryForThisCourse: (courseId, date) =>
     ...
     * @returns {Promise<any>}
     */
    listsSubmissions: (courseId, date, graderId, assignmentId) =>
      helper.get(
     ...
     * @returns {Promise<any>}
     */
    listUncollatedSubmissionVersions: (courseId, query = '') =>

module.exports = (helper) => {
  return {
     ...
     * @returns {Promise<any>}
     */
    retrieveAllQuizReports: (courseId, quizId, query = '') =>
     ...
     * @returns {Promise<any>}
     */
    createQuizReport: (courseId, quizId, body) =>
     ...
     * @returns {Promise<any>}
     */
    getQuizReport: (courseId, quizId, reportId, query = '') =>
      helper.get(
        `/v1/courses/${courseId}/quizzes/${quizId}/reports/${reportId}`,
        query,
      ),
    /**

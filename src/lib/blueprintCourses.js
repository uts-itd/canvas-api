module.exports = (helper) => {
  return {
     ...
     * @returns {Promise<any>}
     */
    getBlueprintInformation: (courseId, templateId) =>
      helper.get(`/v1/courses/${courseId}/blueprint_templates/${templateId}`),
    /**
     ...
     * @returns {Promise<any>}
     */
    getAssociatedCourseInformation: (courseId, templateId) =>
      helper.get(
        `/v1/courses/${courseId}/blueprint_templates/${templateId}/associated_courses`,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    updateAssociatedCourses: (courseId, templateId, body) =>
      helper.put(
        `/v1/courses/${courseId}/blueprint_templates/${templateId}/update_associations`,
        body,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    beginMigrationToPushToAssociatedCourses: (courseId, templateId, body) =>
      helper.post(
        `/v1/courses/${courseId}/blueprint_templates/${templateId}/migrations`,
        body,
      ),
    /**
    ...
    setOrRemoveRestrictionsOnBlueprintCourseObject: (
      ...
      helper.put(
        `/v1/courses/${courseId}/blueprint_templates/${templateId}/restrict_item`,
        body,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    getUnsyncedChanges: (courseId, templateId) =>
      helper.get(
        `/v1/courses/${courseId}/blueprint_templates/${templateId}/unsynced_changes`,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    listBlueprintMigrations: (courseId, templateId) =>
      helper.get(
        `/v1/courses/${courseId}/blueprint_templates/${templateId}/migrations`,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    showBlueprintMigration: (courseId, templateId, migrationId) =>
      helper.get(
     ...
     * @returns {Promise<any>}
     */
    getMigrationDetails: (courseId, templateId, migrationId) =>
      helper.get(
     ...
     * @returns {Promise<any>}
     */
    listBlueprintImports: (courseId, subscriptionId) =>
      helper.get(
        `/v1/courses/${courseId}/blueprint_subscriptions/${subscriptionId}/migrations`,
      ),
    /**
     ...
     * @returns {Promise<any>}
     */
    showBlueprintImport: (courseId, subscriptionId, migrationId) =>
      helper.get(
     ...
     * @returns {Promise<any>}
     */
    getImportDetails: (courseId, subscriptionId, migrationId) =>
      helper.get(

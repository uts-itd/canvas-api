module.exports = (helper) => {
  return {
     ...
     * @returns {Promise<any>}
     */
    listCourseSections: (courseId, query = '') =>
     ...
     * @returns {Promise<any>}
     */
    createCourseSection: (courseId, body) =>
     ...
     * @returns {Promise<any>}
     */
    crossListSection: (sectionId, newCourseId) =>
     ...
     * @returns {Promise<any>}
     */
    getSectionInformationCourses: (courseId, sectionId, query = '') =>
     ...
     * @returns {Promise<any>}
     */
    getSectionInformationSections: (sectionId, query = '') =>

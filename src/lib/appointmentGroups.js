module.exports = (helper) => {
  return {
     ...
     * @returns {Promise<any>}
     */
    listAppointmentGroups: (query = '') =>
      helper.get(`/v1/appointment_groups`, query),
    /**
     ...
     * @returns {Promise<any>}
     */
    createAppointmentGroup: (body) =>
      helper.post(`/v1/appointment_groups`, body),
    /**
     ...
     * @returns {Promise<any>}
     */
    getSingleAppointmentGroup: (appointmentGroupId, query = '') =>
     ...
     * @returns {Promise<any>}
     */
    updateAppointmentGroup: (appointmentGroupId, body) =>
     ...
     * @returns {Promise<any>}
     */
    deleteAppointmentGroup: (appointmentGroupId, query = '') =>
     ...
     * @returns {Promise<any>}
     */
    listUserParticipants: (appointmentGroupId, query = '') =>
     ...
     * @returns {Promise<any>}
     */
    listStudentGroupParticipants: (appointmentGroupId, query = '') =>

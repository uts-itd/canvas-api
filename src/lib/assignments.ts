...
export default function (helper: Helper) {
  return {
     ...
     * @returns {Promise<any>}
     */
    deleteAssignment: (courseId: string | number, assignmentId: string | number) =>
     ...
     * @returns {Promise<any>}
     */
    listAssignments: (courseId: string | number, query?: any) =>
     ...
     * @returns {Promise<any>}
     */
    listAssignmentsForUser: (userId: string | number, courseId: string | number) =>
     ...
     * @returns {Promise<any>}
     */
    getSingleAssignment: (courseId: string | number, assignmentId: string | number, query?: any) =>
     ...
     * @returns {Promise<any>}
     */
    createAssignment: (courseId: string | number, body: any) =>
     ...
     * @returns {Promise<any>}
     */
    editAssignment: (courseId: string | number, assignmentId: string | number, body: any) =>
     ...
     * @returns {Promise<any>}
     */
    listAssignmentOverrides: (courseId: string | number, assignmentId: string | number) =>
      helper.get(`/v1/courses/${courseId}/assignments/${assignmentId}/overrides`),
    /**
     ...
     * @returns {Promise<any>}
     */
    batchRetrieveOverridesInCourse: (courseId: string | number, query?: any) =>
     ...
     * @returns {Promise<any>}
     */
    batchCreateOverridesInCourse: (courseId: string | number, body: any) =>
     ...
     * @returns {Promise<any>}
     */
    batchUpdateOverridesInCourse: (courseId: string | number, body: any) =>

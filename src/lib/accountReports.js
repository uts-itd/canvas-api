module.exports = (helper) => {
  return {
     ...
     * @returns {Promise<any>}
     */
    listAvailableReports: (accountId) =>
     ...
     * @returns {Promise<any>}
     */
    startReport: (accountId, report, body) =>
     ...
     * @returns {Promise<any>}
     */
    indexOfReports: (accountId, report) =>
     ...
     * @returns {Promise<any>}
     */
    statusOfReport: (accountId, report, reportId) =>
     ...
     * @returns {Promise<any>}
     */
    deleteReport: (accountId, report, reportId) =>
